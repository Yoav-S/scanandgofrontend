        ...
        <SafeAreaView style={[styles.container, { backgroundColor: background }]}>
            ...
            <ScrollView style={styles.ScrollViewCon}>
                <Text style={[{ color: text.primary }, styles.textstyle]}>
                    ...
                    These terms and conditions outline the rules and regulations for the use of [Your Company Name]'s Website and Mobile Application.

                    By accessing this Website and Mobile Application, we assume you accept these terms and conditions. Do not continue to use [Your App Name] if you do not agree to take all of the terms and conditions stated on this page.
                    ...
                    Cookies: We employ the use of cookies. By accessing [Your App Name], you agreed to use cookies in agreement with [Your Company Name]'s Privacy Policy.

                    Most interactive websites use cookies to let us retrieve the user’s details for each visit. Cookies are used by our website to enable the functionality of certain areas to make it easier for people visiting our website. Some of our affiliate/advertising partners may also use cookies.

                    License: Unless otherwise stated, [Your Company Name] and/or its licensors own the intellectual property rights for all material on [Your App Name]. All intellectual property rights are reserved. You may access this from [Your App Name] for your own personal use subjected to restrictions set in these terms and conditions.
